(function (global, factory) {
	...
	function childReconciler(shouldTrackEffects) {
	    ...
	    return function reconcileChildrenFibers(returnFiber, currentFiber, newChild) {
	        ...
	        if (typeof newChild === 'string' || typeof newChild === 'number') {
	            placeSingleChild(reconcilerSingleTextNode(returnFiber, currentFiber, newChild));
	        }
	        {
	            console.warn('未实现的reconcile类型', newChild);
	        }
	...
	function markUpdateFromFiberOnFiber(fiber) {
	    let node = fiber;
	...
	function commitRoot(root) {
	    ...
	    const subtreeHaasEffect = (finishedWork.subtreeFlags & MutationMask) !== NoFlags;
	...
	function updateContainer(element, root) {
	    ...
	    const updateQueue = createUpdate(element);
	    enqueueUpdate(hostRootFiber.updateQueue, updateQueue);
